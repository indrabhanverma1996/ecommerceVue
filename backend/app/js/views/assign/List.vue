                              ...
                              <tr v-for="assign in this.assignedData">
                                 ...
                                 <td class="text-center">
                                    <ul class="list-unstyled list-inline m-0">
                                       ...
                                       <router-link :to='{name:"ReportShow",params:{id:assign.test_taker.id}}' target="_blank" v-if="hasPermission('ACandidates-view')"><button
                                       ...
                                       <li class="list-inline-item mb-2" title="Edit" v-tooltip="tooltip.edit"
                                          ...
                                          <router-link :to='{name:"AssignEditOne",params:{id:assign.id}}' v-if="hasPermission('ACandidates-edit')"><button
                                       ...
                                       <li class="list-inline-item mb-2" title="Delete" v-tooltip="tooltip.delete"
                                          ...
                                          <button class="btn btn-sm btn-light-danger p-0 text-center h-30px w-30px"
                                             type="button" @click="deleteCandidate(assign.id)" v-if="hasPermission('ACandidates-delete') "><i
