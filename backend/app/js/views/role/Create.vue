<template>
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title me-3 mb-5 mb-lg-0 lh-1">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-3">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <p class="text-muted m-0 fs-5">Create Roles</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post" v-if="hasPermission('roles-create')" >
                    ...
                    <div class="col-md-12 col-12 d-flex">
                        <div class="card card-xl-stretch mb-xl-8 w-100">
                            <div class="card-header border-0">
                                <h3 class="card-title fw-bolder text-dark m-0">Create New Role</h3>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="test" class="form-control form-control-solid form-control-sm" v-model="role.name" placeholder="Enter Role Name" required/>
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-12">
                                            <label for="ques-name" class="mb-3 fw-bolder fs-5"> Select Permissions<span class="text-danger">*</span></label>
                                            <select class="form-control form-control-solid form-control-sm"  multiple v-model="role.permission" required>
...
export default {
    ...
    methods:{
        ...
        async create(){
            ...
            Role.add(this.role).then(response => {                
